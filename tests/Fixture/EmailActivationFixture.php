...
/**
 * EmailActivationFixture
 *
 */
class EmailActivationFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'activation_key' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'status' => 1,
            'deleted' => 1,
            'deleted_date' => '2018-05-01 06:38:40',
            'created' => '2018-05-01 06:38:40',
            'modified' => '2018-05-01 06:38:40'
        ],
    ];
}
