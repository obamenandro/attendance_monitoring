...
class UserLogsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'page' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'created' => '2018-12-15 11:29:15',
            'modified' => '2018-12-15 11:29:15'
        ],
    ];
}
